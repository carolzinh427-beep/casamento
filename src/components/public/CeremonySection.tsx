...
export default function CeremonySection({
  ...
  return (
    <section id="cerimonia" className="py-20 md:py-28 bg-[#FAF7F2] border-t border-[#E8DFD5]/60">
          ...
          <div className="lg:col-span-6 p-8 sm:p-12 flex flex-col justify-between">
            <div>
              ...
              <div className="flex items-start gap-3 mb-6">
                <MapPin className="w-5 h-5 text-[#52796F] shrink-0 mt-1" />
                <div>
                  <h3 className="text-lg font-serif font-semibold text-[#2C302E]">Local da Celebração</h3>
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 w-full py-3.5 px-6 rounded-full bg-[#52796F] hover:bg-[#354F52] text-white text-xs font-semibold tracking-[0.2em] uppercase transition-all shadow-sm hover:shadow-md cursor-pointer"
            >
